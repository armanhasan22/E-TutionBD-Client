...
const { data: tutions = [], } = useQuery({
  ...
  queryFn: async () => {
    ...
    return res.data; // You must return the data here!
  }
});
...
// };
    ...
    return (
        <div className=''>
                    <h2 className="text-2xl gap-2 mb-4 text-center font-extrabold text-blue-950 p-3"> Total  Tuitions : {tutions.length}</h2>
